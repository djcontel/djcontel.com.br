...
<html>
  <head>
    ...
    <link id="favicon" href="<?php fileVersion("_lib/images/favicon.ico"); ?>" rel="icon">
    ...
    <link href="<?php fileVersion("_lib/css/main.css"); ?>" rel="stylesheet">
<?php
...
?>
        ...
        <ul class="stacks">
          ...
          <li><i class="devicon-html5-plain-wordmark" title="HTML5"></i></i></li>
